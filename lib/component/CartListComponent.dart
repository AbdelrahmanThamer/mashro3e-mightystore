            ...
            children: <Widget>[
              if (cartStore.cartList.isNotEmpty)
                cartStore.cartList[i].full == null
                    ? CachedNetworkImage(imageUrl: cartStore.cartList[i].gallery!.validate().toString()[0], fit: BoxFit.cover, height: 85, width: 85).cornerRadiusWithClipRRect(8)
                    : CachedNetworkImage(imageUrl: cartStore.cartList[i].full.toString().validate(), fit: BoxFit.cover, height: 85, width: 85).cornerRadiusWithClipRRect(8),
              8.width,
              Expanded(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
