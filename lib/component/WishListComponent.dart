...
class WishListComponent extends StatefulWidget {
  ...
  WishListComponent({Key? key, this.mWishListModel, required this.onClick}) : super(key: key);
          ...
          Column(
            ...
            children: [
              ...
              Row(
                children: <Widget>[
                  PriceWidget(
                      price: widget.mWishListModel!.salePrice!.isNotEmpty ? widget.mWishListModel!.salePrice.toString() : widget.mWishListModel!.price.toString(), size: 16, color: primaryColor),
                  4.width,
                  PriceWidget(price: widget.mWishListModel!.regularPrice.toString(), size: 14, color: Theme.of(context).textTheme.subtitle1!.color, isLineThroughEnabled: true)
...
/*  removeWishListItemDialog(BuildContext context, WishListResponse data) {
