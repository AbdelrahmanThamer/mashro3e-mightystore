        ...
        ? SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                mVendorModel!.banner!.isNotEmpty
                    ? Container(
                        ...
                        decoration: BoxDecoration(
                          image: DecorationImage(fit: BoxFit.fill, image: CachedNetworkImageProvider(mVendorModel!.banner.validate())),
                        ),
                ...
                mOption(mVendorModel!.phone != null ? mVendorModel!.phone : '', Theme.of(context).textTheme.subtitle1!.color).visible(mVendorModel!.phone!.isNotEmpty),
