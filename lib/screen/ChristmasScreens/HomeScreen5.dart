...
import 'package:mightystore/component/HomeDataComponent.dart';
import 'package:mightystore/component/HomeScreenComponent5/DashBoard5Product.dart';
import 'package:mightystore/component/HomeScreenComponent5/DashBoard5VendorComponent.dart';
import 'package:mightystore/component/HomeScreenComponent5/DashboardComponent5.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(appLocalization.translate('app_name')!, style: boldTextStyle(size: 18, color: white)),
