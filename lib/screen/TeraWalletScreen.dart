...
import 'package:mightystore/component/AddMoneyComponent.dart';
import 'package:mightystore/component/TeraWalletHistoryComponent.dart';
import 'package:mightystore/main.dart';
import 'package:mightystore/models/WalletConfigurationResponse.dart';
import 'package:mightystore/models/WalletResponse.dart';
        ...
        builder: (context) {
          return Stack(
            children: [
              ...
              ).visible(!appStore.isLoading&&Error!=null),
