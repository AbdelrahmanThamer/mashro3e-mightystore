  ...
  Widget build(BuildContext context) {
              ...
              child: Row(
                ...
                children: [
                  ...
                  Text(
                      ...
                      textAlign: TextAlign.center,
                      style: boldTextStyle(color: primaryColor, wordSpacing: 2, size: 14)),
                ],
              ),
            ),
    ...
    final mCartData = productDetailNew != null
        ? Container(
            padding: EdgeInsets.all(10),
            decoration:
                boxDecorationWithRoundedCorners(borderRadius: BorderRadius.circular(8), backgroundColor: productDetailNew!.inStock! ? context.primaryColor : textSecondaryColorGlobal.withOpacity(0.3)),
            child: Row(
              mainAxisAlignment: MainAxisAlignment.center,
              crossAxisAlignment: CrossAxisAlignment.center,
              children: [
                ...
                children: [
                  PriceWidget(
                      price: productDetailNew!.salePrice.toString().isNotEmpty
                          ...
                          : double.parse(productDetailNew!.price.toString()).toStringAsFixed(2),
                      size: 18,
                      color: primaryColor),
                  PriceWidget(
          ...
          if (value > 0) {
            return Row(
              children: [
                ...
                PriceWidget(price: value.toStringAsFixed(2), size: 18, color: Theme.of(context).textTheme.subtitle1!.color)
              ],
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          FittedBox(
                            ...
                            final double? result = await ReviewScreen(mProductId: productDetailNew!.id).launch(context);
                            if (result == null) {
                              rating = rating;
                              setState(() {});
                            } else {
                            ...
                            Wrap(
                              children: mProductOptions.map((e) {
                                ...
                                return Container(
                                  ...
                                  padding: EdgeInsets.all(8),
                                  decoration: boxDecorationWithRoundedCorners(
                                      backgroundColor: selectedOptionAvailableIn == index ? bgCardColor : context.cardColor, border: Border.all(width: 0.1, color: context.iconColor)),
