    ...
    final mCartData = productDetailNew != null
        ? GestureDetector(
            ...
            child: Container(
              padding: EdgeInsets.all(10),
              decoration: boxDecorationWithRoundedCorners(
                  borderRadius: BorderRadius.circular(8), backgroundColor: productDetailNew!.inStock! ? context.primaryColor : textSecondaryColorGlobal.withOpacity(0.3)),
              child: Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  ...
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        if (productDetailNew!.store != null)
                          Row(
                            ...
                            children: [
                              Row(
                                children: [
                                  Text(appLocalization!.translate('lbl_vendor')!, style: primaryTextStyle(color: Theme.of(context).textTheme.subtitle1!.color))
                        ...
                        Text(appLocalization.translate('lbl_shop_category')!, style: boldTextStyle()).paddingOnly(left: 12, right: 12, top: 8),
                        4.height,
                        Wrap(
