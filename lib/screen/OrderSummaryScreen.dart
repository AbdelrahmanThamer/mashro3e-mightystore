...
class OrderSummaryScreenState extends State<OrderSummaryScreen> implements TransactionCallBack {
  ...
  void createNativeOrder(String mPaymethod, {bool isWallet = false, bool isPayment = false}) async {
    ...
    return Scaffold(
                        ...
                        Column(
                          children: [
                            ...
                            Row(
                              ...
                              children: [
                                Text(appLocalization.translate("msg_remaining_amount")!, style: primaryTextStyle(size: 18)),
                                PriceWidget(price: mAmount.toString(), color: primaryColor, size: 16)
                              ],
                            ),
                                  ...
                                  children: <Widget>[
                                    Container(
                                      ...
                                      decoration: boxDecorationWithRoundedCorners(
                                        ...
                                        backgroundColor: context.cardColor,
                                        border: Border.all(
                                          color: currentTimeValue == index ? primaryColor! : Theme.of(context).textTheme.subtitle2!.color!,
                                        ),
                                      ),
                                    ...
                                    Expanded(
                                      child: Text(
                                        ...
                                        style: secondaryTextStyle(size: 16, color: currentTimeValue == index ? primaryColor : Theme.of(context).textTheme.subtitle1!.color),
                                      ),
                                    ),
                                  ],
                                ).onTap(
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              Text("-", style: primaryTextStyle(color: primaryColor)),
                              PriceWidget(price: widget.discount.validate(), size: 16, color: Theme.of(context).textTheme.subtitle1!.color),
                            ],
                          ),
                        ],
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          PriceWidget(price: widget.mPrice, size: 16, color: primaryColor),
                        ],
                      ),
                    ],
                  ).paddingAll(16),
      ...
      bottomNavigationBar: Container(
        ...
        child: Row(
          ...
          children: [
            PriceWidget(price: widget.mPrice, size: 16, color: Theme.of(context).textTheme.subtitle2!.color).expand(),
            16.height,
            AppButton(
  ...
  void _wallet() {
    ...
    if (widget.mPrice.toString().toDouble() <= mTotalBalance.toDouble()) {
      createNativeOrder("Wallet", isWallet: true, isPayment: false);
    } else if (widget.mPrice.toString().toDouble() >= mTotalBalance.toDouble()) {
