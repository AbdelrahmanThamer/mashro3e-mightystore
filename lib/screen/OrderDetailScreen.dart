      ...
      return SingleChildScrollView(
        child: Column(
          ...
          children: <Widget>[
            ...
            Divider(thickness: 6, color: Theme.of(context).textTheme.headline4!.color).visible(widget.mOrderModel!.lineItems!.length > 1),
            Container(
              width: context.width(),
              margin: EdgeInsets.only(bottom: 8),
              padding: EdgeInsets.fromLTRB(16, 8, 16, 8),
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                      children: [
                                        PriceWidget(price: widget.mOrderModel!.lineItems![i].total.toString(), size: 18.toDouble(), color:primaryColor),
                                        4.width,
              ...
              child: Column(
                ...
                children: [
                  ...
                  RichText(
                    text: TextSpan(
                      children: [
                        WidgetSpan(child: Icon(Icons.email, size: 16, color: Theme.of(context).textTheme.subtitle1!.color).paddingRight(10)),
