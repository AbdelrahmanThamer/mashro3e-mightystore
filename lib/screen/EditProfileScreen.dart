                  ...
                  children: [
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                              shape: BoxShape.circle, border: Border.all(color: Theme.of(context).textTheme.subtitle2!.color!, width: 1), color: Theme.of(context).scaffoldBackgroundColor),
                          child: IconButton(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: selectedBillingState != null
                              ...
                              : Text("NA", style: primaryTextStyle(color: Theme.of(context).textTheme.subtitle1!.color)).paddingOnly(top: 12, bottom: 12).center(),
                        ).expand()
                      ],
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            Text(appLocalization.translate('lbl_same')!, style: secondaryTextStyle(color: Theme.of(context).textTheme.subtitle2!.color, size: 16)),
