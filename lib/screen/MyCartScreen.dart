...
import 'package:mightystore/component/CartListComponent.dart';
import 'package:mightystore/component/ShippingComponent.dart';
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                PriceWidget(price: cartStore.cartTotalAmount, color: Theme.of(context).textTheme.subtitle1!.color, size: 16),
              ],
            ),
            4.height,
            Row(
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    PriceWidget(price: cartStore.cartTotalDiscount.toStringAsFixed(2), color: primaryColor, size: 16),
                  ],
                )
              ],
                ...
                ? Row(
                    ...
                    children: [
                      ...
                      cartStore.shippingMethods[selectedShipment].cost != null && cartStore.shippingMethods[selectedShipment].cost!.isNotEmpty
                          ? PriceWidget(price: cartStore.shippingMethods[selectedShipment].cost, color: Theme.of(context).textTheme.subtitle1!.color, size: 16)
