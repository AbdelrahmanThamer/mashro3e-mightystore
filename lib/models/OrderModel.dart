...
class OrderResponse {
    ...
    OrderResponse({this.billing, this.cartHash, this.cartTax, this.createdVia, this.currency, this.customerId, this.customerIpAddress, this.customerNote, this.customerUserAgent, this.dateCompleted, this.dateCreated, this.dateModified, this.datePaid, this.discountTax, this.discountTotal, this.id, this.lineItems, this.metaData, this.number, this.orderKey, this.parentId, this.paymentMethod, this.paymentMethodTitle, this.pricesIncludeTax, this.shipping, this.shippingTax, this.shippingTotal, this.status, this.total, this.totalTax, this.transactionId, this.version});
...
class LineItem {
    ...
    // ignore: non_constant_identifier_names
    LineItem({this.productId, this.metaData, this.name, this.orderId, this.product_id, this.productImages, this.quantity, this.subtotal, this.subtotalTax, this.taxClass, this.total, this.totalTax, this.variationId});
